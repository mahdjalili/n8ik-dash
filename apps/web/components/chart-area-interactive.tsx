...
export function ChartAreaInteractive() {
    ...
    return (
        <Card className="@container/card">
            <CardHeader>
                <CardTitle>بازدیدکنندگان کل</CardTitle>
                <CardDescription>
                    <span className="hidden @[540px]/card:block">کل برای ۳ ماه گذشته</span>
                ...
                <CardAction>
                    ...
                    >
                        <ToggleGroupItem value="90d">۳ ماه گذشته</ToggleGroupItem>
                        <ToggleGroupItem value="30d">۳۰ روز گذشته</ToggleGroupItem>
                        <ToggleGroupItem value="7d">۷ روز گذشته</ToggleGroupItem>
                    </ToggleGroup>
